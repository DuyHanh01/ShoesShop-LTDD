...
public class ShoesFragment extends androidx.fragment.app.Fragment {
    ...
    @Override
    public android.view.View onCreateView(@androidx.annotation.NonNull android.view.LayoutInflater inflater, @androidx.annotation.Nullable android.view.ViewGroup container, @androidx.annotation.Nullable android.os.Bundle savedInstanceState) {
...
//       searchView.setIconified(true);
    ...
    private void Init(android.view.View view) {
        recyclerView=view.findViewById(com.example.shopsneaker.R.id.recycleviewShoesByBrand);
        //
...
//        txt_sortGia=view.findViewById(id.giathapdencao);
        ...
        txtcountsp= view.findViewById(com.example.shopsneaker.R.id.txtcountsp);
    }
}
